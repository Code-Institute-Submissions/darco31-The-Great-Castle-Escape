...
def start():
    ...
    P_STAT(Fore.YELLOW + " Its big but cold and damp, you notice a window", 2)
...
def return_to_table():
    ...
    P_STAT("You quickly get back to the right hand door", 2)
    go_right_back()
...
def back_to_window():
    ...
    if open_window == "y" or open_window == "yes":
        ...
        P_STAT(Fore.BLUE + " You peer through the dark and the rain and can just", 2)
        P_STAT(Fore.BLUE + " make out the sloping roof. You jump and to your horror ", 2)
...
def go_right_back():
    ...
    """
    P_STAT(" Using the key you push the door open and enter", 2)
