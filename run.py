...
def outside():
    ...
    if new_choice == "d":
        ...
        P_STAT(Fore.BLUE + f" with their {new_weapon_two.weapon_type}'s", .5)
        P_STAT(Fore.BLUE + f" you raise the {new_weapon_two.weapon_type}", .5)
        P_STAT(Fore.BLUE + f" you found {new_weapon_two.condition}", 2)
